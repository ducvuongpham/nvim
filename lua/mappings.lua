...
-- Change operations without saving to clipboard (use black hole register)
map("n", "c", '"_c', { desc = "Change without yank" })
map("n", "C", '"_C', { desc = "Change to end of line without yank" })
map("n", "cc", '"_cc', { desc = "Change line without yank" })
map("x", "c", '"_c', { desc = "Change selection without yank" })
